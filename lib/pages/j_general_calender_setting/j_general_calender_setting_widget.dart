...
import 'j_general_calender_setting_model.dart';
export 'j_general_calender_setting_model.dart';

class JGeneralCalenderSettingWidget extends StatefulWidget {
  const JGeneralCalenderSettingWidget({super.key});

  static String routeName = 'J-General_Calender_setting';
  static String routePath = '/jGeneralCalenderSetting';

  @override
  State<JGeneralCalenderSettingWidget> createState() =>
      _JGeneralCalenderSettingWidgetState();
}

class _JGeneralCalenderSettingWidgetState
    extends State<JGeneralCalenderSettingWidget> {
  late JGeneralCalenderSettingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JGeneralCalenderSettingModel());
