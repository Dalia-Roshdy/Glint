...
import 'n_add_client_model.dart';
export 'n_add_client_model.dart';
...
class NAddClientWidget extends StatefulWidget {
  const NAddClientWidget({
    super.key,
    this.client,
  });
  ...
  static String routeName = 'N-Add_Client';
  static String routePath = '/nAddClient';

  @override
  State<NAddClientWidget> createState() => _NAddClientWidgetState();
}

class _NAddClientWidgetState extends State<NAddClientWidget> {
  late NAddClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NAddClientModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (currentUserDocument?.role == Role.resource) {
        ...
        if (widget.client != null) {
          safeSetState(() {
            _model.clientNameTextController?.text = valueOrDefault<String>(
              widget.client?.name,
              'name',
            );
          });
                              ...
                              children: [
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                          MClientsManagmentWidget.routeName);
                                    },
                                    child: Icon(
                                      Icons.clear_sharp,
                                      color: FlutterFlowTheme.of(context)
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: (_model.clientNameTextController
                                                      .text ==
                                                  '')
                                          ? null
                                          : () async {
                                              ...
                                              if (_model.form!) {
                                                if (widget.client != null) {
                                                  if (widget.client?.name ==
                                                    ...
                                                    context.pushNamed(
                                                        MClientsManagmentWidget
                                                            .routeName);
                                                  } else {
                                                    _model.countUpd =
                                                        await queryClientsRecordCount(
                                                      queryBuilder:
                                                          (clientsRecord) =>
                                                              clientsRecord
                                                                  .where(
                                                    ...
                                                    if (_model.countUpd == 0) {
                                                      ...
                                                      _model.errorMS =
                                                          'Please choose a unique client name.';
                                                      safeSetState(() {});
                                                    }
                                                  }
                                                } else {
