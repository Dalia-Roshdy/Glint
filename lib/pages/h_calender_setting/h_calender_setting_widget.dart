...
import 'h_calender_setting_model.dart';
export 'h_calender_setting_model.dart';

class HCalenderSettingWidget extends StatefulWidget {
  const HCalenderSettingWidget({super.key});

  static String routeName = 'H-Calender_setting';
  static String routePath = '/hCalenderSetting';

  @override
  State<HCalenderSettingWidget> createState() => _HCalenderSettingWidgetState();
}

class _HCalenderSettingWidgetState extends State<HCalenderSettingWidget> {
  late HCalenderSettingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HCalenderSettingModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.calendar = await queryCalendarSettingsRecordOnce(
        queryBuilder: (calendarSettingsRecord) => calendarSettingsRecord.where(
          'user_id',
      ...
      _model.workingDays =
          _model.calendar!.workingPattern.toList().cast<WorkingDayHourStruct>();
      _model.generalCalAct = await CalendarSettingsRecord.getDocumentOnce(
          _model.calendar!.parentCalendar!);
      safeSetState(() {
        _model.generalCalendarTypeValueController?.value =
            _model.generalCalAct!.type!;
      });
      _model.generalCalendar = _model.generalCalAct;
      safeSetState(() {});
    });
