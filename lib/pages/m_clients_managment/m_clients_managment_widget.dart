...
import 'm_clients_managment_model.dart';
export 'm_clients_managment_model.dart';

class MClientsManagmentWidget extends StatefulWidget {
  const MClientsManagmentWidget({super.key});

  static String routeName = 'M-Clients_Managment';
  static String routePath = '/mClientsManagment';

  @override
  State<MClientsManagmentWidget> createState() =>
      _MClientsManagmentWidgetState();
}

class _MClientsManagmentWidgetState extends State<MClientsManagmentWidget> {
  late MClientsManagmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MClientsManagmentModel());
                            ...
                            children: [
                              Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context
                                        .pushNamed(NAddClientWidget.routeName);
                                  },
                                  text: '+',
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return FlutterFlowDataTable<
                                          ...
                                          dataRowBuilder: (clientsDataListItem,
                                                  clientsDataListIndex,
                                                  selected,
                                                  onSelectChanged) =>
                                              DataRow(
                                            selected: selected,
