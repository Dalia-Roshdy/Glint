...
class ASignInUPModel extends FlutterFlowModel<ASignInUPWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in emailAddress_register widget.
  int? count;
  ...
  String? _passwordCreateTextControllerValidator(
    ...
    if (!RegExp('^(?=.*[a-z])(?=.*\\d)[A-Za-z\\d!@#\$%^&*]{8,}\$')
        .hasMatch(val)) {
      return 'Password must include a lowercase letter and a number.';
    }
    return null;
  }
