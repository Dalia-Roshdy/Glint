...
import 'resource_calender_model.dart';
export 'resource_calender_model.dart';
...
///
class ResourceCalenderWidget extends StatefulWidget {
  const ResourceCalenderWidget({super.key});

  @override
  State<ResourceCalenderWidget> createState() => _ResourceCalenderWidgetState();
}

class _ResourceCalenderWidgetState extends State<ResourceCalenderWidget> {
  late ResourceCalenderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResourceCalenderModel());
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 1.0, 0.0),
                            child: Container(
                              width: MediaQuery.sizeOf(context).width * 0.976,
                              height: 94.48,
                              decoration: BoxDecoration(
