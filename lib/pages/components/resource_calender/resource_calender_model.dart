...
import 'resource_calender_widget.dart' show ResourceCalenderWidget;
import 'package:flutter/material.dart';

class ResourceCalenderModel extends FlutterFlowModel<ResourceCalenderWidget> {
  ...
  // Stores action output result for [Backend Call - API (WorkLoadTest)] action in Resource_calender widget.
