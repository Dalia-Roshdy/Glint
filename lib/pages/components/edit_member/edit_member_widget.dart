...
/// create component as form display user info (name, email , phone) read only
/// and role as select drop down
/// use same style of project
            ...
            children: [
                    ...
                    children: [
                      ...
                      FlutterFlowDropDown<Role>(
                        controller: _model.roleValueController ??=
                          ...
                          _model.roleValue ??= widget.member?.role,
                        ),
                        options: List<Role>.from(Role.values),
                        optionLabels: Role.values.map((e) => e.name).toList(),
                        onChanged: (val) =>
              ...
              Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: (_model.roleValue == null)
                        ? null
                        : () async {
                            ...
                            context.goNamed(IUsersManagementWidget.routeName);
                          },
                    text: 'Save Changes',
                    options: FFButtonOptions(
                      width: 140.0,
                      ...
                      borderRadius: BorderRadius.circular(8.0),
                      disabledColor: Color(0xFFB9CCF0),
                    ),
                  ),
                ],
              ),
