                ...
                children: [
                        ...
                        builder: (context) => InkWell(
                          ...
                          onTap: () async {
                            if (currentUserDocument?.role != Role.resource) {
                              context.pushNamed(
                                  K1AllocationViewRescourceViewWidget
                                      .routeName);
                            } else {
                              await showDialog(
                                context: context,
                  ...
                  Align(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        context
                            .pushNamed(JGeneralCalenderSettingWidget.routeName);
                      },
                      child: Container(
                        width: 45.0,
                        height: 45.0,
                        ...
                        builder: (context) => InkWell(
                          ...
                          onTap: () async {
                            if (currentUserDocument?.role == Role.admin) {
                              context
                                  .pushNamed(IUsersManagementWidget.routeName);
                            } else {
                              await showDialog(
                                context: context,
                                builder: (dialogContext) {
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(MClientsManagmentWidget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
