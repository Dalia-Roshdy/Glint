...
import 'calendarwidget_widget.dart' show CalendarwidgetWidget;
import 'package:flutter/material.dart';

class CalendarwidgetModel extends FlutterFlowModel<CalendarwidgetWidget> {
  ...
  // Stores action output result for [Backend Call - API (WorkLoadTest)] action in calendarwidget widget.
