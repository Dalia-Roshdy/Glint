...
import 'e_project_management_new_model.dart';
export 'e_project_management_new_model.dart';

class EProjectManagementNewWidget extends StatefulWidget {
  const EProjectManagementNewWidget({super.key});

  static String routeName = 'E-Project_management_new';
  static String routePath = '/eProjectManagementNew';

  @override
  State<EProjectManagementNewWidget> createState() =>
      _EProjectManagementNewWidgetState();
}

class _EProjectManagementNewWidgetState
    extends State<EProjectManagementNewWidget> {
  late EProjectManagementNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EProjectManagementNewModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      Function() _navigate = () {};
      if (currentUserDocument?.calendarId == null) {
        GoRouter.of(context).prepareAuthEvent();
        await authManager.signOut();
        GoRouter.of(context).clearRedirectLocation();

        _navigate = () =>
            context.goNamedAuth(ASignInUPWidget.routeName, context.mounted);
      } else {
                          ...
                          children: [
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: _model.userProjectList.length
                                        .toString(),
                                    style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (_model.showPicture <= 8)
                                    Expanded(
                                      child: Align(
                                        alignment:
                                            AlignmentDirectional(0.0, 1.0),
                                        child: wrapWithModel(
                                          model: _model.messageAddModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: MessageAddWidget(),
                                        ),
                                      ),
                                    ),
