...
import 'c_edit_team_members_model.dart';
export 'c_edit_team_members_model.dart';
...
class CEditTeamMembersWidget extends StatefulWidget {
  const CEditTeamMembersWidget({
    super.key,
  ...
  static String routeName = 'C-Edit_Team_members';
  static String routePath = '/cEditTeamMembers';

  @override
  State<CEditTeamMembersWidget> createState() => _CEditTeamMembersWidgetState();
}

class _CEditTeamMembersWidgetState extends State<CEditTeamMembersWidget> {
  late CEditTeamMembersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEditTeamMembersModel());
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Form(
                            ...
                            child: FutureBuilder<ProjectPermissionsRecord>(
                              future: ProjectPermissionsRecord.getDocumentOnce(
                                  _model.projectPer!.reference),
                              builder: (context, snapshot) {
                                ...
                                final columnProjectPermissionsRecord =
                                    snapshot.data!;
                                        ...
                                        child: Padding(
                                          ...
                                          child: FutureBuilder<UsersRecord>(
                                            future: UsersRecord.getDocumentOnce(
                                                columnProjectPermissionsRecord
                                                    .userId!),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              if (!snapshot.hasData) {
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await columnProjectPermissionsRecord
                                                  .reference
                                                  .update(
                        ...
                        FutureBuilder<List<ProjectPermissionsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemCount:
                                  listViewProjectPermissionsRecordList.length,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            if (listViewProjectPermissionsRecord
                                                .canAllocate)
                                              Text(
                                                'Can Allocate',
                                                style:
