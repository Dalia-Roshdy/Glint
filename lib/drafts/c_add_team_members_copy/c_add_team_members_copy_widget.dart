...
import 'c_add_team_members_copy_model.dart';
export 'c_add_team_members_copy_model.dart';
...
class CAddTeamMembersCopyWidget extends StatefulWidget {
  const CAddTeamMembersCopyWidget({
    super.key,
  ...
  static String routeName = 'C-Add_Team_membersCopy';
  static String routePath = '/cAddTeamMembersCopy';

  @override
  State<CAddTeamMembersCopyWidget> createState() =>
      _CAddTeamMembersCopyWidgetState();
}

class _CAddTeamMembersCopyWidgetState extends State<CAddTeamMembersCopyWidget> {
  late CAddTeamMembersCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAddTeamMembersCopyModel());
    ...
    _model.roleTextFieldTextController1 ??= TextEditingController();
    _model.roleTextFieldFocusNode1 ??= FocusNode();

    _model.switchValue1 = false;
    _model.roleTextFieldTextController2 ??= TextEditingController(
        text: valueOrDefault<String>(
      _model.isUpdate
          ? valueOrDefault<String>(
              _model.projPerSelected?.roleInProject,
              'role',
            )
          : 'role',
      'role',
    ));
    _model.roleTextFieldFocusNode2 ??= FocusNode();

    _model.switchValue2 =
        _model.isUpdate == true ? _model.projPerSelected!.canAllocate : false;
                ...
                child: FutureBuilder<List<ProjectPermissionsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ProjectPermissionsRecord>
                        containerProjectPermissionsRecordList = snapshot.data!;
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .roleTextFieldTextController1,
                                                    focusNode: _model
                                                        .roleTextFieldFocusNode1,
                                                    autofocus: true,
                                                    autofillHints: [
                                                      AutofillHints.email
                                                    ],
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Has priviliage to allocate on this  project',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .roleTextFieldTextController2,
                                                    focusNode: _model
                                                        .roleTextFieldFocusNode2,
                                                    autofocus: true,
                                                    autofillHints: [
                                                      AutofillHints.email
                                                    ],
                            ...
                            if (containerProjectPermissionsRecordList.length !=
                                0)
                              Builder(
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder:
                                        (context, projectPermListIndex) {
                                      final projectPermListItem =
                                          projectPermList[projectPermListIndex];
                                      return Padding(
