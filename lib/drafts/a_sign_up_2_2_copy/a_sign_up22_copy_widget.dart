...
import 'a_sign_up22_copy_model.dart';
export 'a_sign_up22_copy_model.dart';

/// add employee role, phone number, date of birth
class ASignUp22CopyWidget extends StatefulWidget {
  const ASignUp22CopyWidget({super.key});

  static String routeName = 'A-Sign_Up_2-2Copy';
  static String routePath = '/aSignUp22Copy';

  @override
  State<ASignUp22CopyWidget> createState() => _ASignUp22CopyWidgetState();
}

class _ASignUp22CopyWidgetState extends State<ASignUp22CopyWidget>
    with TickerProviderStateMixin {
  late ASignUp22CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ASignUp22CopyModel());
