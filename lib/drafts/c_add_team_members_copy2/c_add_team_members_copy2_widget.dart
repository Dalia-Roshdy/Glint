...
import 'c_add_team_members_copy2_model.dart';
export 'c_add_team_members_copy2_model.dart';
...
class CAddTeamMembersCopy2Widget extends StatefulWidget {
  const CAddTeamMembersCopy2Widget({
    super.key,
  ...
  static String routeName = 'C-Add_Team_membersCopy2';
  static String routePath = '/cAddTeamMembersCopy2';

  @override
  State<CAddTeamMembersCopy2Widget> createState() =>
      _CAddTeamMembersCopy2WidgetState();
}

class _CAddTeamMembersCopy2WidgetState
    extends State<CAddTeamMembersCopy2Widget> {
  late CAddTeamMembersCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAddTeamMembersCopy2Model());
          ...
          child: Row(
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<List<ProjectPermissionsRecord>>(
                  stream: queryProjectPermissionsRecord(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        onPressed: () async {
                                          await ProjectPermissionsRecord
                                            ...
                                            ...createProjectPermissionsRecordData(
                                              ...
                                              userId: _model.userRef?.reference,
                                              roleInProject: _model
                                                  .roleTextFieldTextController
                                                  .text,
                                              canAllocate: _model.switchValue,
                            ...
                            FutureBuilder<List<ProjectPermissionsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProjectPermissionsRecord>
                                    listViewProjectPermissionsRecordList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewProjectPermissionsRecord =
                                        listViewProjectPermissionsRecordList[
                                            listViewIndex];
                                    return Padding(
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child:
                                                  ...
                                                  future: UsersRecord
                                                      .getDocumentOnce(
                                                          listViewProjectPermissionsRecord
                                                              .userId!),
                                                  builder: (context, snapshot) {
                                                    // Customize what your widget looks like when it's loading.
                                                    if (!snapshot.hasData) {
