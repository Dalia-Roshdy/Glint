...
import '/index.dart';
import 'h_calender_setting_copy2_widget.dart' show HCalenderSettingCopy2Widget;
import 'package:flutter/material.dart';

class HCalenderSettingCopy2Model
    extends FlutterFlowModel<HCalenderSettingCopy2Widget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in H-Calender_settingCopy2 widget.
