...
import '/index.dart';
import 'h_calender_setting_copy_widget.dart' show HCalenderSettingCopyWidget;
import 'package:flutter/material.dart';

class HCalenderSettingCopyModel
    extends FlutterFlowModel<HCalenderSettingCopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in H-Calender_settingCopy widget.
